						...
						<div class="footer-content">
							...
							<div class="social-list">
								<a href="https://www.facebook.com/phuxuan.edu.vn/"
									...
									class="fab fa-google"></a> <a
									href="https://www.youtube.com/channel/UCo7NIz3C4vxuqPqJNQcplVQ"
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="footer-col footer-link">
						...
						<div class="footer-content toggle-footer">
							<ul>
								<li class="item"><a href="#" title="Tìm kiếm">Tìm kiếm</a>
								</li>
								<li class="item"><a href="#" title="Giới thiệu">Giới
										thiệu</a></li>
								<li class="item"><a href="#" title="Chính sách đổi trả">Chính
										sách đổi trả</a></li>
								<li class="item"><a href="#" title="Chính sách bảo mật">Chính
										sách bảo mật</a></li>
								<li class="item"><a href="#" title="Điều khoản dịch vụ">Điều
										khoản dịch vụ</a></li>
							</ul>
						</div>
					</div>
