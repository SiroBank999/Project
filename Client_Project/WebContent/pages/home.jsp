...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>  
  ...
  <div class="owl-carousel owl-theme owl-carousel-setting">
    <div class="item"><img src="templates/images/slideshow_1.jpg" class="d-block w-100" alt="..."></div>
    <div class="item"><img src="templates/images/slideshow_2.jpg" class="d-block w-100" alt="..."></div>
</div>
