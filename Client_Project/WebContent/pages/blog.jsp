            ...
            <div class="list-news-latest layered">							
                ...
                <div class="item-article clearfix">                  
                  <div class="post-image">
                    <a href="detailblog?id=${listnews.id}"><img src="Uploads/${listnews.image }" alt="Bài viết mẫu"></a>
                  </div>                 
                ...
                <c:forEach items="${listNews}" var="news">         
                  <div class="col-md-4 col-xs-12 col-sm-12">
                    <a href="detailblog.html" class="blog-post-thumbnail" title="Bài viết mẫu" rel="nofollow">
                      <img src="Uploads/${news.image}" style="margin-bottom :20px" alt="">
                    </a>
                  </div>      
                  <div class="col-md-8 col-xs-12 col-sm-12">
                    ...
                    <div class="blog-post-meta">   
                      ...
                      <span class="date">                
                        <time pubdate="" datetime="2019-06-10">${news.datesub}</time>
                      </span>
                    </div>
