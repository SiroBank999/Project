        ...
        <div class="sidebar-blog">
          <div class="news-latest">
            ...
            <div class="list-news-latest layered">							
                ...
                <div class="item-article clearfix">                 
                  <div class="post-image">
                    <a href=""><img src="templates/images/blog/n-2.jpg" alt="Saucony hồi sinh mẫu giày chạy bộ cổ điển của mình – Aya Runner"></a>
                  </div>                  
                  <div class="post-content">
                    <h3>
                ...
                <div class="item-article clearfix">                  
                  <div class="post-image">
                    <a href=""><img src="templates/images/blog/n-3.jpg" alt="Nike Vapormax Plus trở lại với sắc tím mộng mơ và thiết kế chuyển màu đẹp mắt"></a>
                  </div>                  
                  <div class="post-content">
                    <h3>
                ...
                <div class="blog-post row">  
                  <div class="col-md-4 col-xs-12 col-sm-12">
                    <a href="detailblog.html" class="blog-post-thumbnail" title="Adidas Falcon nổi bật mùa Hè với phối màu color block" rel="nofollow">
                      <img src="templates/images/blog/n-1.jpg" alt="Adidas Falcon nổi bật mùa Hè với phối màu color block">
                    </a>
                  </div>
                ...
                <div class="blog-post row">           
                  <div class="col-md-4 col-xs-12 col-sm-12">
                    <a href="detailblog.html" class="blog-post-thumbnail" title="Saucony hồi sinh mẫu giày chạy bộ cổ điển của mình – Aya Runner" rel="nofollow">
                      <img src="templates/images/blog/n-2.jpg" alt="Saucony hồi sinh mẫu giày chạy bộ cổ điển của mình – Aya Runner">
                    </a>
                  </div>          
                  <div class="col-md-8 col-xs-12 col-sm-12">
                    <h3 class="blog-post-title">
                ...
                <div class="blog-post row">
                  ...
                  <div class="col-md-4 col-xs-12 col-sm-12">
                    <a href="detailblog.html" class="blog-post-thumbnail" title="Nike Vapormax Plus trở lại với sắc tím mộng mơ và thiết kế chuyển màu đẹp mắt" rel="nofollow">
                      <img src="templates/images/blog/n-3.jpg" alt="Nike Vapormax Plus trở lại với sắc tím mộng mơ và thiết kế chuyển màu đẹp mắt">
                    </a>
                  </div>             
                  <div class="col-md-8 col-xs-12 col-sm-12">
                    <h3 class="blog-post-title">
                ...
                <div class="blog-post row">          
                  <div class="col-md-4 col-xs-12 col-sm-12">
                    <a href="detailblog.html" class="blog-post-thumbnail" title="Bài viết mẫu" rel="nofollow">
                      <img src="templates/images/blog/n-4.jpg" alt="Bài viết mẫu">
                    </a>
                  </div>      
                  <div class="col-md-8 col-xs-12 col-sm-12">
                    <h3 class="blog-post-title">
