		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pd5">
				<ol class="breadcrumb breadcrumb-arrows">
					...
					<li><span style="color: #777777">Tất cả sản phẩm</span></li>
				</ol>
			</div>
		</div>
	</div>
						...
						<span class="custom-dropdown custom-dropdown--grey">
							<form method="get" action="" name="productForm">
								<select name="order-by"
									...
									<option value="price-ascending" disabled="disabled">Giá:
										Tăng dần</option>
									<option value="price-descending" disabled="disabled">Giá:
										Giảm dần</option>
