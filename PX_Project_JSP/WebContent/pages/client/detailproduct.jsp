                    ...
                    hidden-xs">
									<div class="product-gallery__thumbs thumb-fix">
										...
										<div class="product-gallery__thumb  active" id="imgg1">
											<a class="product-gallery__thumb-placeholder"
												...
												data-image="templates/client/images/detailproduct/1.jpg"
												data-zoom-image="templates/client/images/detailproduct/1.jpg">
												<img src="templates/client/images/detailproduct/1.jpg"
												data-image="templates/client/images/detailproduct/1.jpg"
										...
										<div class="product-gallery__thumb " id="imgg2">
											<a class="product-gallery__thumb-placeholder"
												href="javascript:void(0);"
												data-image="templates/client/images/detailproduct/5.jpg"
												data-zoom-image="templates/client/images/detailproduct/5.jpg">
												<img src="templates/client/images/detailproduct/5.jpg"
												data-image="templates/client/images/detailproduct/5.jpg"
												alt="Nike Air Max 90 Essential" grape="">
											</a>
										</div>
										...
										<div class="product-gallery__thumb " id="imgg3">
											<a class="product-gallery__thumb-placeholder"
												href="javascript:void(0);"
												data-image="templates/client/images/detailproduct/2.jpg"
												data-zoom-image="templates/client/images/detailproduct/2.jpg">
												<img src="templates/client/images/detailproduct/2.jpg"
												data-image="templates/client/images/detailproduct/2.jpg"
												alt="Nike Air Max 90 Essential" grape="">
											</a>
										</div>
										...
										<div class="product-gallery__thumb " id="imgg4">
											<a class="product-gallery__thumb-placeholder"
												href="javascript:void(0);"
												data-image="templates/client/images/detailproduct/4.jpg"
												data-zoom-image="templates/client/images/detailproduct/4.jpg">
												<img src="templates/client/images/detailproduct/4.jpg"
												data-image="templates/client/images/detailproduct/4.jpg"
												alt="Nike Air Max 90 Essential" grape="">
											</a>
										</div>
										...
										<div class="product-gallery__thumb " id="imgg5">
											<a class="product-gallery__thumb-placeholder"
												href="javascript:void(0);"
												data-image="templates/client/images/detailproduct/7.jpg"
												data-zoom-image="templates/client/images/detailproduct/7.jpg">
												<img src="templates/client/images/detailproduct/7.jpg"
												data-image="templates/client/images/detailproduct/7.jpg"
												alt="Nike Air Max 90 Essential" grape="">
											</a>
										</div>
										...
										<div class="product-gallery__thumb " id="imgg6">
											<a class="product-gallery__thumb-placeholder"
												href="javascript:void(0);"
												data-image="templates/client/images/detailproduct/3.jpg"
												data-zoom-image="templates/client/images/detailproduct/3.jpg">
												<img src="templates/client/images/detailproduct/3.jpg"
												data-image="templates/client/images/detailproduct/3.jpg"
												alt="Nike Air Max 90 Essential" grape="">
											</a>
										</div>
										...
										<div class="product-gallery__thumb " id="imgg7">
											<a class="product-gallery__thumb-placeholder"
												href="javascript:void(0);"
												data-image="templates/client/images/detailproduct/8.jpg"
												data-zoom-image="templates/client/images/detailproduct/8.jpg">
												<img src="templates/client/images/detailproduct/8.jpg"
												data-image="templates/client/images/detailproduct/8.jpg"
												alt="Nike
                            Air Max 90 Essential"
										...
										<div class="product-gallery__thumb " id="imgg8">
											<a class="product-gallery__thumb-placeholder"
												href="javascript:void(0);"
												data-image="templates/client/images/detailproduct/6.jpg"
												data-zoom-image="templates/client/images/detailproduct/6.jpg">
												<img src="templates/client/images/detailproduct/6.jpg"
												data-image="templates/client/images/detailproduct/6.jpg"
												alt="Nike Air Max 90 Essential" grape="">
											</a>
										</div>
                    ...
                    scroll hidden-xs">
                      ...
                      slide_product">
                        ...
                        current "
											...
											src="templates/client/images/detailproduct/1.jpg"
										...
										<li class="product-gallery-item gallery-item " id="imgg2a">
											...
											src="templates/client/images/detailproduct/5.jpg"
											alt="Nike Air Max 90 Essential" grape="">
										</li>

										<li class="product-gallery-item gallery-item " id="imgg3a">
											<img class="product-image-feature"
											src="templates/client/images/detailproduct/2.jpg"
											alt="Nike Air Max 90 Essential" grape="">
										</li>

										<li class="product-gallery-item gallery-ite " id="imgg4a">
											<img class="product-image-feature"
											src="templates/client/images/detailproduct/4.jpg"
											alt="Nike Air Max 90 Essential" grape="">
										</li>

										<li class="product-gallery-item gallery-item " id="imgg5a">
											<img class="product-image-feature"
											src="templates/client/images/detailproduct/7.jpg"
											alt="Nike Air Max 90 Essential" grape="">
										</li>

										<li class="product-gallery-item gallery-item " id="imgg6a">
											<img class="product-image-feature"
											src="templates/client/images/detailproduct/3.jpg"
											alt="Nike Air Max 90 Essential" grape="">
										</li>

										<li class="product-gallery-item gallery-item " id="imgg7a">
											<img class="product-image-feature"
											src="templates/client/images/detailproduct/8.jpg"
											alt="Nike Air Max 90 Essential" grape="">
										</li>

										<li class="product-gallery-item gallery-item " id="imgg8a">
											<img class="product-image-feature"
											src="templates/client/images/detailproduct/6.jpg"
											alt="Nike Air Max 90 Essential" grape="">
										</li>
									...
									<div class="product-block">
										<div class="product-img fade-box">
											<a href="#" title="Adidas EQT Cushion ADV" class="img-resize">
												<img
												src="templates/client/images/shoes/800502_01_e92c3b2bb8764b52a791846d84a3a360_grande.jpg"
	...
	<div class="product-zoom11">
		<div class="product-zom">
			...
			<div class="owl-carousel owl-theme owl-product1">
				...
				<div class="item">
					<img src="templates/client/images/detailproduct/1.jpg" alt="">
				</div>
				<div class="item">
					<img src="templates/client/images/detailproduct/2.jpg" alt="">
				</div>
				<div class="item">
					<img src="templates/client/images/detailproduct/3.jpg" alt="">
				</div>
				<div class="item">
					<img src="templates/client/images/detailproduct/4.jpg" alt="">
				</div>
				<div class="item">
					<img src="templates/client/images/detailproduct/5.jpg" alt="">
				</div>
				<div class="item">
					<img src="templates/client/images/detailproduct/6.jpg" alt="">
				</div>
				<div class="item">
					<img src="templates/client/images/detailproduct/7.jpg" alt="">
				</div>
				<div class="item">
					<img src="templates/client/images/detailproduct/8.jpg" alt="">
				</div>
